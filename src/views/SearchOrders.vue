<template>
    <AuthedUserLayout>
        <div class="px-4 pt-4">
            <navbar title="Поиск грузов"></navbar>
            <div>
            ...
            <div class="col py-3 pt-3">
                <order-list-item v-for="(order, key) in orders" :key="key" type="order" :item="order"/>
            </div>
        </div>
    </AuthedUserLayout>
</template>
...
<script>
    ...
    import GridTypeToggler from '@/components/layout/GridTypeToggler'
